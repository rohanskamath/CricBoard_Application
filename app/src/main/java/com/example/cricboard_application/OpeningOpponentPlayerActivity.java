...
public class OpeningOpponentPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String teamHostName = currentBattingTeam.toUpperCase();
        String teamVisitorName = currentBowlingTeam.toUpperCase();
        String hostInitial = "";
        ...
        hostPlayers = dataBaseHandler.getPlayerNamesByTeamName(sharedPreferences.getVisitorTeamName());
        visitorPlayers = dataBaseHandler.getPlayerNamesByTeamName(sharedPreferences.getHostTeamName());
